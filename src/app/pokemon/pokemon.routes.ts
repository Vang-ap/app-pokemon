  ...
  children: [
    {
      ...
      loadComponent: () =>
        import("./edit-pokemon/edit-pokemon.component").then(
          (module) => module.EditPokemonComponent
        ),
    },
    {
      path: "pokemon/add",
      title: "Ajout de Pokemon",
      loadComponent: () =>
        import("./add-pokemon/add-pokemon.component").then(
          (module) => module.AddPokemonComponent
        ),
    },
    {
      path: "pokemons",
      ...
      loadComponent: () =>
        import("./list-pokemon/list-pokemon.component").then(
          (module) => module.ListPokemonComponent
        ),
    },
    {
      path: "pokemon/:id",
      loadComponent: () =>
        import("./detail-pokemon/detail-pokemon.component").then(
          (module) => module.DetailPokemonComponent
        ),
    },
  ]
}
